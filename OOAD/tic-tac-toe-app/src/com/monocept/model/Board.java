...
public class Board {
	...
	public void markCell(char playerMark, int row, int column) throws CellOccupiedException {
		if (board[row][column] != ' ') {
	...
	public void checkForValidCell(String inputCell) throws InvalidInputException {
